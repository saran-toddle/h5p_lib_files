...
H5P.fullScreen = function (
    ...
    if (body === undefined) {
        ...
        var iframeSelector =
            '#h5p-iframe-' + $element.parent().data('content-id');
    ...
    for (var field in parameters) {
        ...
        if (value && value.library && typeof value.library === 'string') {
            ...
            lastContentTypeName =
                ...
                typeof value.library.library === 'string'
    ...
    if (
        ...
        var dataset = {
            ...
            year: metadata.yearFrom
                ? metadata.yearFrom +
                  (metadata.yearTo ? '-' + metadata.yearTo : '')
                : undefined,
...
H5P.attachToastTo = function (element, message, config) {
    ...
    const getToastCoordinates = function (element, toast, position) {
        ...
        if (
            (position.noOverflowLeft || position.noOverflowX) &&
            left < bounds.x
        ) {
            left = bounds.x;
        }
        ...
        if (
            (position.noOverflowTop || position.noOverflowY) &&
            top < bounds.y
        ) {
            top = bounds.y;
        }
...
H5P.MediaCopyright = function (copyright, labels, order, extraFields) {
    ...
    if (copyright !== undefined) {
        ...
        for (var i = 0; i < order.length; i++) {
            ...
            if (
                copyright[fieldName] !== undefined &&
                copyright[fieldName] !== ''
            ) {
                var humanValue = copyright[fieldName];
                if (fieldName === 'license') {
                    humanValue = humanizeLicense(
                        copyright.license,
                        copyright.version
                    );
                }
...
H5P.setFinished = function (contentId, score, maxScore, time) {
    ...
    if (validScore && H5PIntegration.postUserStatistics === true) {
        ...
        H5P.jQuery
            .post(H5PIntegration.ajax.setFinished, data)
            .fail(function () {
                H5P.offlineRequestQueue.add(
...
(function ($) {
    ...
    H5P.getUserData = function (contentId, dataId, done, subContentId) {
        ...
        if (
            ...
            try {
                    ...
                    undefined,
                    JSON.parse(preloadedData[subContentId][dataId])
                );
            } catch (err) {
                done(err);
            }
    ...
    H5P.ClipboardItem = function (parameters, genericProperty, specificKey) {
        ...
        var setDimensionsFromFile = function () {
            ...
            self.width = 20; // %
            self.height =
                (params.params.file.height / params.params.file.width) *
                self.width;
        };
    ...
    var parseClipboard = function () {
        ...
        if (clipboardData.generic) {
            ...
            clipboardData.generic =
                clipboardData.specific[clipboardData.generic];
        }
        ...
        for (var prop in params) {
            if (params.hasOwnProperty(prop) && params[prop] instanceof Object) {
                ...
                if (obj.path !== undefined && obj.mime !== undefined) {
                    ...
                    if (
                        obj.library !== undefined &&
                        obj.subContentId !== undefined
                    ) {
                        ...
                        if (
                            ...
                            if (state !== undefined) {
                                ...
                                H5P.setUserData(
                                    ...
                                    'state',
                                    state,
                                    { deleteOnChange: true, async: false }
                                );
                            }
                        }
                    }
